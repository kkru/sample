	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<!-- 페이지 처리 -->
				<!-- 페이지정보를 저장하는 form, 사용자한테 보여지지 않게 -->
				...
				<form id="actionForm" action="/board/list" method="get">
					...
					<input type="hidden" name="keyword" 
						value="<c:out value='${pageMaker.cri.keyword }'/>">
					<!-- <input type="hidden" name="bno" value="게시글번호"> -->
				</form>
				...
				<!-- 알림 추가 
            				...
            				우리는 이제 기본함수 안쓰고 Modal이라고 해서 우리가 커스터마이징한 창을 띄워서 알려줌 -->
				<!-- Modal -->
					...
					function() {
						...
						function checkModal(result) {
							...
							if (parseInt(result) > 0) {
								// result (사용자가 등록한 게시물의 번호) 가 0 보다 크면
								$(".modal-body").html(
										"게시글 " + parseInt(result)
												+ " 번이 등록 되었습니다.");
						...
						$(".paginate_button a").on(
								...
								function(e) {
									...
									// action form의 value를 수정해서 보내면 된다.

									// actionForm 에서 name속성이 pageNum인 input태그 찾기
									// input tag의 값을 현재 내가 클릭한 a 태그의 href 값으로 바꿔주면 된다.
						...
						$(".move")
								.on(
										...
										function(e) {
											...
											// form을 보낼때 게시글 번호 정보를 담아서 보내야 한다.
											if (actionForm.find(
												...
												// name이 bno 인 input 태그가 있으면 그 값을 현재 선택한 게시물의 번호로 바꿔줌
												actionForm
														.find(
																"input[name='bno']")
														.val(
