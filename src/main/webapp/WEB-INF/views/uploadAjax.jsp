...
$(document).ready(function() {
	...
	// 파일 이름 안에 exe ? zip ? alz ? sh ? 이런 것들이 포함되어 있는지 검사
	// includes
	...
	$("#uploadBtn").on("click" , function(e){
		...
		// 초기화는 언제 ?? 파일 업로드요청 보내고 나서 성공하고 해야 한다.
		
		
		// ajax 요청 보내기
		// processData , contentType 이 왜 false 인가???
		// contentType : application/json		
		// 우리가 파일을 실어서 보내는데 contentType이 file형식으로 가야된다.
		// false로 넣어줘야 contentType 이 multipart로 설정되서 보내진다.
		// processData : 우리가 ajax 로 요청을 보낼때 data 속성이
